...
echo '<script src="js/question13.js"></script>'; //ACCEDE AL JS CON LAS PREGUNTAS
...
<head>
    ...
    <title>Evaluacion Progresion 11</title>
</head>
<body>
    
    <script>
        const ProgresionActual = document.getElementById("encabezadoEval");
        ProgresionActual.innerHTML = "Evaluación progresión 13";
    </script>
</body>
</html>