...
echo '<script src="js/question2.js"></script>'; //ACCEDE AL JS CON LAS PREGUNTAS
...
<head>
    ...
    <title>Evaluacion Progresion 2</title>
</head>
<body>
   
    <script>
        const ProgresionActual = document.getElementById("encabezadoEval");
        ProgresionActual.innerHTML = "Evaluación progresión 2";
    </script>
</body>
</html>