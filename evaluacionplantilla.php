...
<body>
    ...
    <main  id="main_container_evaluac">
        ...
        <aside class="aside_evaluaciones">
            <a href="evaluacion1.php">Evaluacion 1</a><br>
            <a href="evaluacion2.php">Evaluacion 2</a><br>
            <a href="evaluacion3.php">Evaluacion 3</a><br>
            <a href="evaluacion4.php">Evaluacion 4</a><br>
            <a href="evaluacion5.php">Evaluacion 5</a><br>
            <a href="evaluacion6.php">Evaluacion 6</a><br>
            <a href="evaluacion7.php">Evaluacion 7</a><br>
            <a href="evaluacion8.php">Evaluacion 8</a><br>
            <a href="evaluacion9.php">Evaluacion 9</a><br>
            <a href="evaluacion10.php">Evaluacion 10</a><br>
            <a href="evaluacion11.php">Evaluacion 11</a><br>
            <a href="evaluacion12.php">Evaluacion 12</a><br>
            <a href="evaluacion13.php">Evaluacion 13</a><br>
            <a href="evaluacion14.php">Evaluacion 14</a><br>
        </aside>
    </section>
    <section class="section_evaluacion">
        <div class="home-box custom-box">
            ...
            <p>No hay límite de tiempo, así que tómate el tiempo para realizar las operaciones o cálculos necesarios.</p>
            <p>Las preguntas son presentadas al azar en cada intento.</p>
            <p>Al final, podrás ver tus resultados y, en caso de desearlo, una retroalimentación a cada una de las preguntas.</p>
