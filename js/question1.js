...
const quiz = [
  {
    ...
    option: [
      "Traducción del lenguaje común a símbolos y letras para representar cantidades desconocidas con símbolos.",
      "Lenguaje basado en funciones trigonométricas.",
      "Lenguaje que usa sólo letras y excluye números y signos de operación.",
  ...
  },
  {
    ...
    option: [
      "Elementos agrupadores, potencias y raíces, multiplicación y división, sumas y restas.",
      "Sumas y restas, multiplicación y división, potencias y raíces, elementos agrupadores.",
      "Elementos agrupadores, multiplicación y división, potencias y raíces, sumas y restas.",
      "Potencias y raíces, sumas y restas, elementos agrupadores, multiplicación y división.",
    ],
    answer: 0,
  },
  {
  ...
  },
  {
    ...
    option: [
      "La cantidad de veces que un número se multiplica a sí mismo.",
      "La cantidad que se le debe sumar al número base.",
      "El número por el cual se multiplica el número base.",
      "La cantidad que se le debe restar al número base.",
    ],
    answer: 0,
  },
  {
    ...
    option: [
      "Cantidad que se ha de multiplicar por sí misma una vez para obtener un número determinado.",
      "Cantidad que se ha de restar por sí misma una vez para obtener un número determinado.",
      "Cantidad que se ha de dividir por sí misma una vez para obtener un número determinado.",
      "La raíz de un árbol.",
    ],
    answer: 0,
  },
  {
    ...
    option: [
      "Todas lad opciones son correctas",
      "Aumentar",
      "Mayor que",
      "Incrementar",
    ],
