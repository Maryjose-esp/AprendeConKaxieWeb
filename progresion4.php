    ...
    <aside class="aside" id="asidex4">
        ...
        <section class="sectionAs">
            ...
            <P>Aplica procedimientos, técnicas y lenguaje matemático para la solución de problemas propios del
                Pensamiento Matemático, de Áreas de Conocimiento, <br>Recursos Sociocognitivos, Recursos
                Socioemocionales
                y de su entorno.
            </P>
            <b>
        ...
        <footer class="anteriorsig">
            <div class="panterior"><a href="progresion3.php"><img src="./images/Anterior.png" width=47px
                        style="margin-bottom: -18px;">Anterior</a></div>
            <div class="psiguiente"><a href="progresion5.php">Siguiente<img src="./images/Siguiente.png" width=47px
    ...
    <section class="textP">
        ...
        <div class="conceptosclave">
            ...
            <div class="ceonceptoscla">
                ...
                <P>Números enteros. Conjunto numérico que contiene a la totalidad de los números naturales, a sus
                    inversos negativos y al cero.</P>
                <P>Divisibilidad. Propiedad de los números enteros (números sin decimales) de dividirse por otro número
                    entero y que su resultado sea a su vez un número entero.</P>
                <P>Números primos. Son aquellos que solo son divisibles entre ellos mismos y el 1.</P>
                <P>Conjunto númerico. Agrupaciones que guardan una serie de propiedades estructurales para cada
                    conjunto. </P>
                <P>Lenguaje algebraico. forma de las matemáticas que escribimos con letras, números, potencias y signos.
                </P>
            </div>
        </div>
        <br>
        <h1 id="quees4">¿Qué es la divisibilidad?</h1>
        <P>La divisibilidad en matemáticas se refiere a la propiedad de los números enteros (números sin decimales) de
            ser divididos por otro número entero,
            produciendo un resultado entero. Para determinar si un número puede dividirse entre otro, se utilizan
            criterios específicos de divisibilidad.
            <br>

            <br>
            <center>
                <h2 id="ala4">Algunos criterios de divisibilidad son:</h2>
                <div class="nota">
                    ...
                    <p><br>Para saber si un número es divisible por 10 o pr 5, tampoco necesitamos hacer la dvisión.
                    </P>
                    <ul>
                    ...
                    <ul>
                        <li>Tiene que cumplir dos condiciones, la primera es que tiene que ser divisible por 2, es
                            decir,
                            tiene que ser número par. Segundo tiene que ser divisible por 3, es decir, la suma de sus
                            dígitos tiene
                    ...
                    <ul>
                        <li>Hay que restar el número sin la cifra de las unidades y el doble de la cifra de las
                            unidades.
                        ...
                        <li>Hay que comprobar que sus tres últimas cifras sean divisibles entre 8.
                            ...
                            <ul><br>
                                ...
                                <ul>
                                    ...
                                    <li>Todos estos números son divisibles por 8, porque sus tres útimas cifras, o bien
                                        son 000, o forman un número que es múltiplo de 8.</li>
                                </ul>
                                <li>
                                    <h4>Criterio 2</h4>
                                </li>
                                <ul>
                                    ...
                                    <li>Todos estos números son divisibles por 8, porque sus mitades son divisibles
                                        entre 4</li>
                                </ul>
                            </ul>
                        </li>
                    ...
                    <ul>
                        <li>Cuando la suma de sus dígitos es 9 o múltiplo de 9.
                            <ul>
                                ...
                                <li>Todos estos números son divisibles porque al sumar sus cifras se obtiene un múltiplo
                                    de 9.</li>
                            </ul>
                        </li>
                    </ul>
        ...
        <div id="queson4" class="nota2">
            <p>
            <h3>¿Qué son los números primos?</h3>
            </p>
        ...
        <p><b><br>1.Siguiendo los criterios de divisibilidad y recordando los números primos, comprueba si las
                siguientes
        ...
        <div>
            ...
            <div class="container">
                <div class="text-container">
                    <p>
                        Un número es divisible entre <span class="dropzone" data-word="5"></span> si su última cifra es
                        0 o 5.
                        <br><br>
                        Un número es divisible entre 9, si su última cifra es <span class="dropzone"
                            data-word="9"></span> o multiplo de <span class="dropzone" data-word="9"></span>
                        <br><br>
                        Número que tiene que cumplir 2 condiciones: <span class="dropzone" data-word="6"></span>
                        <br> <br>
                        Un número es divisible por <span class="dropzone" data-word="3"></span> si la suma de sus cifras
                        es múltiplo de 3.
                        <br><br>
                        ¿Qué número es divisible, para que termine en 0? <span class="dropzone" data-word="10"></span>
                        <br><br>
                        Si el resultado es 0 o es múltiplo de 7 entonces el número es divisible entre <span
                            class="dropzone" data-word="7"></span>
                        <br><br>
                        Un número es divisible por <span class="dropzone" data-word="4"></span> si sus 2 últimas cifras
                        son 00 o un múltiplo de 4.
                        <br><br>
                        ¿Cuál número tiene más de 1 criterio? <span class="dropzone" data-word="8"></span>¿Qué número de
                        criterio es cúando sus tres últimas son 000?<span class="dropzone" data-word="1"></span>
                        <br><br>
                        Un número es divisible por 2 si termina en 0 o en: <span class="dropzone"
                            data-word="par"></span> si su última cifra es 0 o 5.
        ...
        <p class="texto-rojo">Recuerda que esta es correcta si en ambos miembros de la ecuación se obtiene el mismo
            número.</p>
        <br>
        <form method="post">
            <div class="columne42">
                ...
                <input type="radio" name="p4e2r1" id="p4e3r1a4" value="1"><label for="p4e3r1a4">no es
                    divisible</label><br><!--si-->
                <br>
                <!-- Pregunta 2 -->
                <h3>4x - 5 = 2 - x</h3>
                <input type="radio" name="p4e2r2" id="p4e2r2a1" value="2"><label for="p4e2r2a1">1</label><br>
                <input type="radio" name="p4e2r2" id="p4e2r2a2" value="1"><label for="p4e2r2a2">no es
                    divisible</label><br><!--si-->
                ...
                <input type="radio" name="p4e2r3" id="p4e2r3a3" value="1"><label for="p4e2r3a3">no es
                    divisible</label><br><!--si-->
                ...
                <!-- Pregunta 4 -->
                <h3>5x + 10 = 3 - 2x</h3>
                <input type="radio" name="p4e2r4" id="p4e2r4a1" value="2"><label for="p4e2r4a1">no es
                    divisible</label><br>
                ...
                <input type="radio" name="p4e2r5" id="p4e2r5a2" value="1"><label for="p4e2r5a2">no es
                    divisible</label><br><!--si-->
                ...
                <input type="radio" name="p4e2r6" id="p4e2r6a3" value="1"><label for="p4e2r6a3">no es
                    divisible</label><br><!--si-->
                ...
                <input type="radio" name="p4e2r7" id="p4e2r7a2" value="2"><label for="p4e2r7a2">no es
                    divisible</label><br>
                ...
                <input type="radio" name="p4e2r8" id="p4e2r8a3" value="3"><label for="p4e2r8a3">no es
                    divisible</label><br>
                ...
                <!-- Pregunta 9 -->
                <h3>3x + 6 = 9 - x</h3>
                <input type="radio" name="p4e2r9" id="p4e2r9a1" value="1"><label for="p4e2r9a1">no es
                    divisible</label><br><!--si-->
                ...
                <input type="radio" name="p4e2r10" id="p4e2r10a2" value="3"><label for="p4e2r10a2">no es
                    divisible</label><br>
                <input type="radio" name="p4e2r10" id="p4e2r10a3" value="1"><label
                    for="p4e2r10a3">2</label><br><!--si-->
