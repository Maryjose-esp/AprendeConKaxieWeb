    ...
    <section id="s1">
        ...
        <br>
            ...
            <footer class="anteriorsig">
                ...
                <div class="psiguiente"><a href ="progresion6.php">Siguiente<img src="./images/Siguiente.png" width=47px style="margin-bottom: -18px;"></a></div>
            </footer>
            </aside>
    <section class="textP">
    <center> <div id= "indice5" class="indice"> 
            <p>
        ...
        <P>El máximo común divisor es el número mayor que divide exactamente a dos  o más números, sin dejar resto.
            ...
            Se  requiere saber los números divisibles de los números  para los cuales se desea encontrar en el MCD y también saber 
            los números primos los cuales son divisibles entre ellos mismos y el 1, si los intentas dividir en otros números el resultado
            no es entero, dicho de otra forma se obtiene un resto distinto de cero.
        </p>
            <br>
            <div id="queson5" class="nota2">
                <p><h2>¿Qué son los números primos?</h2></p>
        ...
        <div class="imgejercicios">
            ...
            <br><h3>Ya recordando esto comencemos: Primero veremos un ejercicio como <b>ejemplo</b>.   </h3> 
            <br>1.- Calcular el MCD de los números 24 y 36. Para este ejemplo se observa que los números que se repiten de ambos lados son el 2 dos veces y 3 una sola.                
            </P>
        <br>
        <form method="post">
        <div class="P5Cont">
        <div class="P5Colum1"><img class="kaxi5p" src="./images/Progresion5img/MCD.png"></div>
            <div class="P5Colum2">
                ...
                <label for="p5e1txt4">¿Cuál es el MCD de 12 y 30? <br><b>MCD:</b></label> <input  type="text" size="5" maxlength="4" name="p5e1txt4" id="p5e1txt4"><br><br>
                <label for="p5e1txt5">¿Cuál es el MCD de 60 y 72? <br><b>MCD:</b></label> <input  type="text" size="5" maxlength="4" name="p5e1txt5" id="p5e1txt5"><br><br>
            </div>
        </div>
        <div>
        ...
        <P>El mínimo común múltiplo (mcm) es el número más pequeño que se puede dividir exactamente entre dos o más números diferentes. 
        Este se puede utilizar en diversas áreas y situaciones, entre ellas:
        <br><br> Matemáticas: El mcm se utiliza en aritmética y álgebra para simplificar fracciones, sumar o restar fracciones con denominadores diferentes, resolver problemas 
        ...
        <div class="imgejercicios">
            ...
            <br>Comencemos: Primero veremos un <b>ejemplo</b> con tres números, utilizaremos el concepto descomponer en factores primos.  
        ...
        <div class="P5Colum1"><img id="ejerc51"  class ="kaxi5p_2" src="./images/Progresion5img/mcd (2).png"> </div>
            ...
            <label for="p5e3txt4">¿Cuál es el mcm de 18, 24, 36 y 48?<br> <b>mcm:</b></label> <input  type="text" size="5" maxlength="4" name="p5e3txt4" id="p5e3txt4"><br><br>
            <label for="p5e3txt5">¿Cuál es el mcm de 3, 4 y 6?<br>        <b>mcm:</b></label> <input  type="text" size="5" maxlength="4" name="p5e3txt5" id="p5e3txt5"><br><br>
        </div>
        </div>
        ...
        <label for="p5e4txt10">10.- En un concurso de talentos, los participantes han firmado un empate para su presentación. Hay presentaciones de 11 minutos, presentaciones de 22 minutos y presentaciones de 33 minutos, ¿cuál es la duración mínima de la competencia?<br>Respuesta: </label><INPUT TYPE ="TEXT" size=6 maxlength="4" NAME="p5e4txt10" id="p5e4txt10"><BR><br>
