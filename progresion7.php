...
<body>
    ...
    <aside class="aside" id="aside7">
        ...
        <Section class="sectionAs">
            ...
            <img src="./images/P7.png" id="KaxieP1"><br><br>
            <b>
                <h3> Metas </h3>
            </b><br>
            <H3>M3</H3>
    ...
    <section class="textP">
        ...
        <div class="mate2_progresion7">
            <div class="responsive_from_mate2">
                <div class="operacion_tamanosr">
                    <math>
                        <mfrac>
                            <mn>a</mn>
                            <mn>b</mn>
                ...
                <P class="textformate2">Esta proporción se lee como "<i>a</i> es a <i>b</i> como <i>c</i> es a
                    <i>d</i>".
                </p>
            </div>
            ...
            <div class="responsive_from_mate2">
                ...
                <p class="textformate2"> De este lado se explican los elementos de la proporción.</p>
            </div>
        ...
        <div class="columne1">
            <form method="post">
                ...
                <input type="text" size="4" maxlength="10" name="p7e1txt1_1" id="p7e1txt1">:<input type="text" size="4"
                    maxlength="10" name="p7e1txt1_2" id="p7e1txt2"><br><br>
                b)<math>
                    <mfrac>
                        <mn>90 </mn>
                        <mn>100 </mn>
                ...
                <input type="text" size="4" maxlength="10" name="p7e1txt2_1" id="p7e1txt3">:<input type="text" size="4"
                    maxlength="10" name="p7e1txt2_2" id="p7e1txt4"><br><br>
                c)<math>
                    <mfrac>
                        <mn>0.547 </mn>
                        <mn>8.5 </mn>
                ...
                <input type="text" size="4" maxlength="10" name="p7e1txt3_1" id="p7e1txt5">:<input type="text" size="4"
                    maxlength="10" name="p7e1txt3_2" id="p7e1txt6"><br><br>
                d)<math>
                    <mfrac>
                        <mn>m </mn>
                        <mn>5n</mn>
                ...
                <input type="text" size="4" maxlength="10" name="p7e1txt5_1" id="p7e1txt9">:<input type="text" size="4"
                    maxlength="10" name="p7e1txt5_2" id="p7e1txt10"><br><br>
                f)<math>
                    <mfrac>
                        <mn>67</mn>
                        <mn>230 </mn>
                ...
                <input type="text" size="4" maxlength="10" name="p7e1txt6_1" id="p7e1txt11">:<input type="text" size="4"
                    maxlength="10" name="p7e1txt6_2" id="p7e1txt12"><br><br>
                g)<math>
                    <mfrac>
                        <mn>0.16 </mn>
                        <mn>7.98 </mn>
                ...
                <input type="text" size="4" maxlength="10" name="p7e1txt7_1" id="p7e1txt13">:<input type="text" size="4"
                    maxlength="10" name="p7e1txt7_2" id="p7e1txt14"><br><br>
                h)<math>
                    <mfrac>
                        <mn>7 </mn>
                        <mn>10 </mn>
                ...
                <input type="text" size="4" maxlength="10" name="p7e1txt8_1" id="p7e1txt15">:<input type="text" size="4"
                    maxlength="10" name="p7e1txt8_2" id="p7e1txt16"><br><br>
                i)<math>
                    <mfrac>
                        <mn>x³</mn>
                        <mn>9 </mn>
                ...
                <input type="text" size="4" maxlength="10" name="p7e1txt9_1" id="p7e1txt17">:<input type="text" size="4"
                    maxlength="10" name="p7e1txt9_2" id="p7e1txt18"><br><br>
                ...
                <input type="text" size="4" maxlength="10" name="p7e1txt10_1" id="p7e1txt19">:<input type="text"
                    size="4" maxlength="10" name="p7e1txt10_2" id="p7e1txt20"><br><br>
                k)<math>
                    <mfrac>
                        <mn>16.4 </mn>
                        <mn>99.01 </mn>
                ...
                <input type="text" size="4" maxlength="10" name="p7e1txt11_1" id="p7e1txt21">:<input type="text"
                    size="4" maxlength="10" name="p7e1txt11_2" id="p7e1txt22"><br><br>
                l)<math>
                    <mfrac>
                        <mn>10.78 </mn>
                        <mn>u </mn>
                ...
                <input type="text" size="4" maxlength="10" name="p7e1txt12_1" id="p7e1txt23">:<input type="text"
                    size="4" maxlength="10" name="p7e1txt12_2" id="p7e1txt24"><br><br>
                m)<math>
                    <mfrac>
                        <mn>4.5 </mn>
                        <mn>9</mn>
                ...
                <input type="text" size="4" maxlength="10" name="p7e1txt13_1" id="p7e1txt25">:<input type="text"
                    size="4" maxlength="10" name="p7e1txt13_2" id="p7e1txt26"><br><br>
                n)<math>
                    <mfrac>
                        <mn>1 </mn>
                        <mn>2</mn>
                ...
                <input type="text" size="4" maxlength="10" name="p7e1txt14_1" id="p7e1txt27">:<input type="text"
                    size="4" maxlength="10" name="p7e1txt14_2" id="p7e1txt28"><br><br>
                ñ)<math>
                    <mfrac>
                        <mn>0.5</mn>
                        <mn>100 </mn>
                ...
                <input type="text" size="4" maxlength="10" name="p7e1txt15_1" id="p7e1txt29">:<input type="text"
                    size="4" maxlength="10" name="p7e1txt15_2" id="p7e1txt30"><br><br>
                o)<math>
                    <mfrac>
                        <mn>12 </mn>
                        <mn>15 </mn>
                ...
                <input type="text" size="4" maxlength="10" name="p7e1txt16_1" id="p7e1txt31">:<input type="text"
                    size="4" maxlength="10" name="p7e1txt16_2" id="p7e1txt32"><br><br>
                p)<math>
                    <mfrac>
                        <mn>100.2 </mn>
                        <mn>34.5 </mn>
                ...
                <input type="text" size="4" maxlength="10" name="p7e1txt17_1" id="p7e1txt33">:<input type="text"
                    size="4" maxlength="10" name="p7e1txt17_2" id="p7e1txt34"><br><br>
                q)<math>
                    <mfrac>
                        <mn>n²³ </mn>
                        <mn>r </mn>
                ...
                <input type="text" size="4" maxlength="10" name="p7e1txt18_1" id="p7e1txt35">:<input type="text"
                    size="4" maxlength="10" name="p7e1txt18_2" id="p7e1txt36"><br><br>
        ...
        <Div class="columne2">
            <form method="post">
                a) 451:500
                <input type="text" size="4" maxlength="10" name="p7e2txt1_1" id="p7e2txt1">/<input type="text" size="4"
                    maxlength="10" name="p7e2txt1_2" id="p7e2txt2"><br>
                b) 1.87:2
                <input type="text" size="4" maxlength="10" name="p7e2txt2_1" id="p7e2txt3">/<input type="text" size="4"
                    maxlength="10" name="p7e2txt2_2" id="p7e2txt4"><br>
                c) 1.2:3.4
                <input type="text" size="4" maxlength="10" name="p7e2txt3_1" id="p7e2txt5">/<input type="text" size="4"
                    maxlength="10" name="p7e2txt3_2" id="p7e2txt6"><br>
                d) x:y
                <input type="text" size="4" maxlength="10" name="p7e2txt4_1" id="p7e2txt7">/<input type="text" size="4"
                    maxlength="10" name="p7e2txt4_2" id="p7e2txt8"><br>
                e) m<sup>2</sup>:56
                <input type="text" size="4" maxlength="10" name="p7e2txt5_1" id="p7e2txt9">/<input type="text" size="4"
                    maxlength="10" name="p7e2txt5_2" id="p7e2txt10"><br>
                f) 2y<sup>4</sup>:10y
                <input type="text" size="4" maxlength="10" name="p7e2txt6_1" id="p7e2txt11">/<input type="text" size="4"
                    maxlength="10" name="p7e2txt6_2" id="p7e2txt12"><br>
                g) 10:30
                <input type="text" size="4" maxlength="10" name="p7e2txt7_1" id="p7e2txt13">/<input type="text" size="4"
                    maxlength="10" name="p7e2txt7_2" id="p7e2txt14"><br>
                h) 1.9:5
                <input type="text" size="4" maxlength="10" name="p7e2txt8_1" id="p7e2txt15">/<input type="text" size="4"
                    maxlength="10" name="p7e2txt8_2" id="p7e2txt16"><br>
                i) 685.5:438.11
                <input type="text" size="4" maxlength="10" name="p7e2txt9_1" id="p7e2txt17">/<input type="text" size="4"
                    maxlength="10" name="p7e2txt9_2" id="p7e2txt18"><br>
                j) 77:55
                <input type="text" size="4" maxlength="10" name="p7e2txt10_1" id="p7e2txt19">/<input type="text"
                    size="4" maxlength="10" name="p7e2txt10_2" id="p7e2txt20"><br>
                k) 540:10
                <input type="text" size="4" maxlength="10" name="p7e2txt11_1" id="p7e2txt21">/<input type="text"
                    size="4" maxlength="10" name="p7e2txt11_2" id="p7e2txt22"><br>
                l) y<sup>3</sup>:3m
                <input type="text" size="4" maxlength="10" name="p7e2txt12_1" id="p7e2txt23">/<input type="text"
                    size="4" maxlength="10" name="p7e2txt12_2" id="p7e2txt24"><br>
                m) 78:14
                <input type="text" size="4" maxlength="10" name="p7e2txt13_1" id="p7e2txt25">/<input type="text"
                    size="4" maxlength="10" name="p7e2txt13_2" id="p7e2txt26"><br>
                n) 99.2:100
                <input type="text" size="4" maxlength="10" name="p7e2txt14_1" id="p7e2txt27">/<input type="text"
                    size="4" maxlength="10" name="p7e2txt14_2" id="p7e2txt28"><br>
                ñ) 8.4:17.1
                <input type="text" size="4" maxlength="10" name="p7e2txt15_1" id="p7e2txt29">/<input type="text"
                    size="4" maxlength="10" name="p7e2txt15_2" id="p7e2txt30"><br>
                <div class="pdcontainer">
        ...
        <div class="columne5">
            ...
            <form method="post">
                ...
                <input type="text" size="4" maxlength="10" style="margin-left: -33px;" name="p7e4txt1"
                    id="p7e4txt1"><br><br>
                ...
                <input type="text" size="4" maxlength="10" style="margin-left: -58px;" name="p7e4txt2"
                    id="p7e4txt2"><br><br>
                ...
                <input type="text" size="4" maxlength="10" style="margin-left: -58px;" name="p7e4txt3"
                    id="p7e4txt3"><br><br>
                ...
                <input type="text" size="4" maxlength="10" style="margin-left: -58px;" name="p7e4txt4"
                    id="p7e4txt4"><br><br>
                ...
                <input type="text" size="4" maxlength="10" style="margin-left:-165px;" name="p7e4txt12"
                    id="p7e4txt12"><br><br>
                ...
                <input type="text" size="4" maxlength="10" style="margin-left: -150px;" name="p7e4txt13"
                    id="p7e4txt13"><br><br>
                ...
                <input type="text" size="4" maxlength="10" style="margin-left: -160px;" name="p7e4txt14"
                    id="p7e4txt14"><br><br>
                ...
                <input type="text" size="4" maxlength="10" style="margin-left: -110px;" name="p7e4txt15"
                    id="p7e4txt15"><br><br>
        </div>
        <div class="pdcontainer">
        ...
        <form method="post">
            ...
            <p>1. El sueldo de un vendedor se compone de la siguiente manera: por caada $1500 en venta, obtiene una
                ganancia
                de $800 y por
                cada hora que labore le dan otros $200. Bryan en la semana logró vender un total de $6350 y trabajó 35
                horas
                ¿Cuánto ganó
                esta semana?</p>
            ...
            <p>2. Alicia desea pintar su casa de color lila. En la tienda de pintura le dijeron que por cada bote de 15
                ...
                aproximadamente. Si en total su casa tiene 978 m^2 ¿Cuántos botes necesita para poder pintar su casa?
            </p>
            R=<input type="text" size="8" maxlength="10" name="p7e5txt2" id="p7e5txt2"><br>
            <br>
            <p>3. En una tienda de mayoreo por la compra de 7 bolsas de palomitas se regala 2 botellas de salsa de 250
                ml.
                Maria se dedica a
                vender dulces en la coperativa de la escuela,si ha comprado 31 bolsas entonces ¿Cuántas bolsas de salsa
                le
                han regalado por la
                compra de hoy?</p>
            R=<input type="text" size="8" maxlength="10" name="p7e5txt3" id="p7e5txt3"><br>
            <br>
            <p>4. Kenia compró 7 paquetes de hojas blancas por las cuales ha pagado $980. Su hermana adquirió 12
                paquetes
                ¿Cuánto pagó en
                total la hermana de Kenia?</p>
            R=<input type="text" size="8" maxlength="10" name="p7e5txt4" id="p7e5txt4"><br>
            <br>
            <p>5. Para poder pasar la materia de biología se han dado los siguientes criterios: 1 punto por 40
                asistencias,
                ...
                sólo hizo 5 tareas con las siguientes calificaciones: 7.8, 9, 10, 8 y 9.5; en el examen obtuvo un 8.3 y
                sólo
            ...
            <br>
            <p>6. Elena decidió realizar algunas lavandas de papel para decorar su habitación. Por cada 3 hojas obtiene
                7
                lavandas. Si desea
        ...
        <p>Tras tener "x<sup>2</sup>" se pasa la potencia a la inversa, es decir, pasa a raíz cuadrada de la
        ...
        <div class="columne4">
            <form method="post">
                ...
                </math>x=<input type="text" size="8" maxlength="10" name="p7e6txt9" id="p7e6txt9"><br>
                <br>
                <math>
                    <mfrac>
                        <mn>785</mn>
        ...
        <p> Resuelve los siguientes problemas.</p>
        <form method="post">
            1. Hoy el dólar está 17.65 así que Jaime y su familia fueron a un banco a cambiar algunos dólares que
            tenían.
            Jaime llevó 36,
            ...
            <br><br>
            2. En el supermercado 3 jabones en barra están a 43 pesos. Gael lleva 400 pesos y planea comprar jabones
            para
            todo el año
            ...
            ¿Cuántos días necesita Karla si ayer se desveló 2 horas?<input type="text" size=5 maxlength="10"
                name="p7e7txt8" id="p7e7txt8"><br>
            ¿Cuántas horas se ha desvelado una persona si requiere de 32 días para recuperar esas horas?<input
                type="text" size=5 maxlength="10" name="p7e7txt9" id="p7e7txt9"><br>
            ¿A cuántas horas de desvelo equivalen 107 días de recuperación?<input type="text" size=5 maxlength="10"
                name="p7e7txt10" id="p7e7txt10"><br>
            ¿Cuántas días necesita dormir Hilda si no ha dormido 2 días a lo largo de una semana?<input type="text"
                size=5 maxlength="10" name="p7e7txt11" id="p7e7txt11"><br>
            <br>
            <br>
            5. Una maestra tarda 4 horas y 20 minutos haciendo 5 figuras de goma eva ¿Cuánto tardará si hace 16
            figuras?<br>
            ...
            ¿A los cuántos minutos tenía 15%?<input type="text" size=5 maxlength="10" name="p7e7txt14"
                id="p7e7txt14"><br>
            ¿A los cuántos minutos tenía 23%?<input type="text" size=5 maxlength="10" name="p7e7txt15"
                id="p7e7txt15"><br>
            ¿Cuánta carga tendrá cuando hayan pasado 200 minutos?<input type="text" size=5 maxlength="10"
                name="p7e7txt16" id="p7e7txt16"><br>
            ¿Cuánta batería tendrá cuando hayan pasado 146 minutos?<input type="text" size=5 maxlength="10"
                name="p7e7txt17" id="p7e7txt17"><br>
            ¿A los cuántos minutos estará totalmente cargado?<input type="text" size=5 maxlength="10" name="p7e7txt18"
                id="p7e7txt18">
            <br><br>
            <div class="pdcontainer">
        ...
        <div class="pdcontainer">
            <div>
                <p>1. En un hormiguero hay 50 hormigas, las cuales han recolectado 7 kilogramos de
                    ...
                    llegaron otras 4, otras 10 y así hasta que fueron 200 hormigas, ¿Cuánto tiempo durará la comida?</p>
                <br>
                <table class="table2p7">
                    <tr>
                        <td>50</td>
        ...
        <form method="post">
            1. En un parque de atracciones hay un laberinto de muchos metros cuadrados, para mantner bien dicha
            atracción
            contratatan
            a 4 jardineros, los cuales hacen su trabajo en 6 horas. Entonces, la empresa decide hacer algunas pruebas
            para
            ver qué cantidad
            de trabajores le conviene contratatr, esa cantidad se determinará cuando un grupo logre mantener la
            atracción en
            menos de
            una hora.<br>
            <table>
            ...
            2. Para la celebración de fin de año se ha comisionado a un grupo de 5 mujeres para que tejan una manta
            gigante
            con la figura
            ...
            <span style="color:red;">NOTA: Redonde los días al número más cercano, teniendo en cuenta los
                decimales.</span><br>
            8 = <input type="text" size=5 maxlength="10" name="p7e8txt5" id="p7e8txt5"> 3=<input type="text" size=5
                maxlength="10" name="p7e8txt7" id="p7e8txt7">
            Necesitan=<input type="text" size=5 maxlength="10" name="p7e8txt6" id="p7e8txt6">

            <br><br>
            3. En una granja tienen 100 vacas a los cuales alimentan semanalmente con 460 kilos de heno, cantidad que se
            divide de
            manera igualitaria, empero, de esas vacas, 20 tuvieron crías, es decir, ahora son 120 vacas por lo que los
            460 kilos se dividen entre 120.
            ¿Cuánto heno le va a tocar ahora a cada vaca?<br>
            R=<input type="text" size=5 maxlength="10" name="p7e8txt8" id="p7e8txt8">
            <br><br>

            4. Graciela acaba de regresar de un viaje de 9 meses y tiene muchos regalos para sus nietos, primero
            comenzará a
            repartir los
            colores y bolígrafos. Traía en total 378 colores para dividir entre los 4 nietos, pero al final la nieta
            mayor
            dijo no necesitar
            lápices de colores así que el reparto sólo se hará entre los 3 menores ¿De cuántos colores le toca a cada
            uno?
            ...
            <br><br>
            5. Rocko está excavando un agujero en el parque mientras su cuidador está platicando con un amigo, así que
            trata
            de excavar
            lo más rápido que puede, aunque lograr la profundidad que quiere le tomará al menos 20 minutos, tiempo que
            no
            tiene.
            Posteriormente otro perro se une, luego dos más y finalmente son 8 perros excavando ¿Cuánto tiempo tomará
            hacer
            el agujero
            ...
            6. Quique ha colocado una fonda en su casa donde le ha estado yendo muy bien, eso quiere decir que las 3
            señoras
            que
            hacen las tortillas no son suficientes para atender tanta gente, con 3 señoras el cliente tiene que esperar
            5
            minutos por una
            ...
            7. Una familia ha salido de excursión con víveres para 28 días y para 6 personas, es decir, los miembros de
            su
            familia ¿Para
        ...
        <P>Realiza las siguientes actividades. Si algunas cantidades tienen más de un número después del punto,
            considere 2.</P>
        <DIV CLASS="columnep">
            <form method="post">
            ...
            <form method="post">
                1. Qué tanto por ciento de 230 es 120.<input type="text" size=5 maxlength="10" name="p7e10txt1"
                    id="p7e10txt1"><BR>
                2. Qué tanto por ciento de 3400 es 989.<input type="text" size=5 maxlength="10" name="p7e10txt2"
                    id="p7e10txt2"><BR>
                3. Qué tanto por ciento de 10000 es 6700.<input type="text" size=5 maxlength="10" name="p7e10txt3"
                    id="p7e10txt3"><BR>
                4. Qué tanto por ciento de 700 es 100.<input type="text" size=5 maxlength="10" name="p7e10txt4"
                    id="p7e10txt4"><BR>
                5. Qué tanto por ciento de 8900 es 310.<input type="text" size=5 maxlength="10" name="p7e10txt5"
                    id="p7e10txt5"><BR>
                6. Qué tanto por ciento de 100 es 9.<input type="text" size=5 maxlength="10" name="p7e10txt6"
                    id="p7e10txt6"><BR>
                7. Qué tanto por ciento de 720 es 5.<input type="text" size=5 maxlength="10" name="p7e10txt7"
                    id="p7e10txt7"><BR>
                8. Qué tanto por ciento de 1000 es 670.<input type="text" size=5 maxlength="10" name="p7e10txt8"
                    id="p7e10txt8"><BR>
                9. Qué tanto por ciento de 5111 es 3910.<input type="text" size=5 maxlength="10" name="p7e10txt9"
                    id="p7e10txt9"><BR>
                10. Qué tanto por ciento de 1111 es 111.<input type="text" size=5 maxlength="10" name="p7e10txt10"
                    id="p7e10txt10"><BR>
                11. Qué tanto por ciento de 9200 es 8134.<input type="text" size=5 maxlength="10" name="p7e10txt11"
                    id="p7e10txt11"><BR>
                12. Qué tanto por ciento de 4000 es 3999.<input type="text" size=5 maxlength="10" name="p7e10txt12"
                    id="p7e10txt12"><BR>
                13. Qué tanto por ciento de 12 es 1.<input type="text" size=5 maxlength="10" name="p7e10txt13"
                    id="p7e10txt13"><BR>
                14. Qué tanto por ciento de 2890 es 28.<input type="text" size=5 maxlength="10" name="p7e10txt14"
                    id="p7e10txt14"><BR>
                15. Qué tanto por ciento de 300 es 10.<input type="text" size=5 maxlength="10" name="p7e10txt15"
                    id="p7e10txt15"><BR>
                <div class="pdcontainer">
            ...
            <DIV>
                <form method="post">
                    ...
                    40% examen.
                    10% exposición.
                    Ana tiene 3 participaciones, 35 asistencias, 4 tareas, sacó 9 en el ezamen y 10 en la exposición
                    ¿Qué
                    calificación obtuvo?
                    En cambio, Juan tiene 7 participaciones, 40 asistencias, 3 tareas, 7 en el examen y 10 en la
                    exposición
                    ...
                    <BR>
                    4. Jimena colecciona pegatinas, tiene 23 de color azul, 70 de color verde, 67 de color rosa, 21 de
                    color
                    blanco, 80 de color púrpura, 109 de color gris,
                    133 de color rosa, 56 de color naranja y 99 de color amarillo ¿Qué porcentaje representa cada color
                    de
                    pegatinas?<BR>
                    ...
                    ¿Para cuántos paquetes le alcanzará si además tiene un cupón de descuento de 20% en compras de más
                    de
                    200 pesos?<BR>
