...
Bueno, al momento de girar el lado MN y hacer la homotecia, obtenemos la línea de segmento 
 ...
 existe el de Jha Savaran que plantea el problema a partir de un hexágono.
            ...
            <INPUT TYPE="radio" name="p10e1r2" id="p10e1r2a1" value="1"> <label for="p10e1r1a1">Al dibujar triángulos equiláteros 
            ...
            <INPUT TYPE="radio" name="p10e1r2" id="p10e1r2a2" value="2"> <label for="p10e1r1a2">La suma de los cuadrados de los 
                catetos de un triángulo rectángulo es igual a la hipotenusa</label><BR><br>
            <INPUT TYPE="radio" name="p10e1r2" id="p10e1r2a3" value="3"> <label for="p10e1r1a3">Toda recta paralela a un lado 
            ...
            <INPUT TYPE="radio" name="p10e1r3" id="p10e1r3a1" value="3"> <label for="p10e1r2a1"> Una potencia. </label> <BR><br>
            <INPUT TYPE="radio" name="p10e1r3" id="p10e1r3a2" value="2"> <label for="p10e1r2a2"> Una onomatopeya. </label><BR><br>
            <INPUT TYPE="radio" name="p10e1r3" id="p10e1r3a3" value="1"> <label for="p10e1r2a3"> Una ampliación. </label><BR><br><br>

            <P><b>3.- ¿Por cuántos grados se tiene que girar el lado 
                del triángulo en la forma de comprobación mencionada?</b></p><br>
            <INPUT TYPE="radio" name="p10e1r4" id="p10e1r4a1" value="1"> <label for="p10e1r3a1"> 30° </label> <BR><br>
            <INPUT TYPE="radio" name="p10e1r4" id="p10e1r4a2" value="2"> <label for="p10e1r3a2"> 60° </label><BR><br>
            <INPUT TYPE="radio" name="p10e1r4" id="p10e1r4a3" value="3"> <label for="p10e1r3a3"> 45° </label><BR><br><br>

            <P><b>4.- ¿En qué sentido se tiene que girar?</b></p><br>
            <INPUT TYPE="radio" name="p10e1r5" id="p10e1r5a1" value="1"> <label for="p10e1r4a1"> De las manecillas del reloj. </label> <BR><br>
            <INPUT TYPE="radio" name="p10e1r5" id="p10e1r5a2" value="2"> <label for="p10e1r4a2"> Contrario a las manecillas del reloj. </label><BR><br><br>

            <P><b>5.- ¿Qué es un triángulo equilátero?</b></p><br>
            <INPUT TYPE="radio" name="p10e1r6" id="p10e1r6a1" value=""> <label for="p10e1r5a1"> Ninguno de sus lados son iguales. </label> <BR><br>
            <INPUT TYPE="radio" name="p10e1r6" id="p10e1r6a2" value=""> <label for="p10e1r5a2"> El que cuenta con todos sus lados y ángulos iguales. </label><BR><br>
            <INPUT TYPE="radio" name="p10e1r6" id="p10e1r6a3" value=""> <label for="p10e1r5a3"> Tiene dos lados iguales. </label><BR><br><br>

            <P><b>6.- ¿Cuál es una de las variantes de este teorema?</b></p><br>
            <INPUT TYPE="radio" name="p10e1r10" id="p10e1r10a1" value="3"> <label for="p10e1r6a1"> Teorema de Euclides </label><BR><br>
            <INPUT TYPE="radio" name="p10e1r10" id="p10e1r10a2" value="1"> <label for="p10e1r6a2"> Teorema de Jha Savaran </label><BR><br> <!--Correcta-->
            <INPUT TYPE="radio" name="p10e1r10" id="p10e1r10a3" value="2"> <label for="p10e1r6a3"> Teorema de Pitágoras </label><BR><br><br>
            ...
            <img src="./../images/congruencia.png" WIDTH=30%>
            ...
            <img src="./../images/congruencia-LAL.png" WIDTH=30%><br>
            ...
            <p>Dos triángulos son congruentes cuando dos ángulos interiores y el lado entre ellos tienen 
                ...
                <img src="./../images/congruencia-ALA.png" WIDTH=30%><br>
            <p><b>LLL (lado, lado, lado)</p></b>
            <p>Dos triángulos son congruentes si sus tres lados son iguales.</p>
            <img src="./../images/congruencia-LLL.png" WIDTH=30%><br>
